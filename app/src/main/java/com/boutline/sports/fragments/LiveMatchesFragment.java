 ...
 */
public class LiveMatchesFragment extends Fragment implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    LiveMatchesAdapter matchesAdapter;
    ...
    public void populateListViewFromDb(View v)
    {
        ...
        String[] fromFieldNames = new String[] {"_id","matchvenue"};

        int[] toViewIDs = new int[]
                {R.id.lblMatchName,R.id.lblMatchVenue};

        matchesAdapter = new LiveMatchesAdapter(getActivity(),R.layout.item_match,null,fromFieldNames,toViewIDs,0);
        listView = (ListView) v.findViewById(R.id.live_matches_list);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_live_matches,null);
